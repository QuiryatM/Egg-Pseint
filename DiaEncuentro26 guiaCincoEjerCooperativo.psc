...
Algoritmo guiaCincoEjerCooperativo
...
//Básicamente lo que hace es a j le suma o le resta la cantidad de posiciones que sacamos en la variable cantAMover
//Para la derecha
//	Para j = 11 Hasta 0 Con Paso -1
//		Si (j+cantAMover) <= 11 y (j+cantAMover) >= 0 Entonces
//			matrizOrdenada[i,j+cantAMover] = matriz[i,j]
//		FinSi
//	FinPara
//	O para la izquierda
//		Para j = 0 hasta 11
//			Si (j+cantAMover) >= 0 y (j+cantAMover) <= 11 Entonces
//				matrizOrdenada[i,j+cantAMover] = matriz[i,j]
//			FinSi
//		FinPara
//	FinSi
//	
//	Por último, con este código va recorriendo la matriz y la va actualizando para cambiar las palabras de lugar
//		para i = 0 hasta 8
//			para j = 0 hasta 11
//				matriz[i,j] = matrizOrdenada[i,j]
//			FinPara
//		FinPara